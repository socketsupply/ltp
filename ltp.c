...
}string_u8* decode__basic_name (byte* buf) { return (string_u8*)decode_relp__u8(buf+5); }array_u8* decode__basic_list (byte* buf) { return (array_u8*)decode_relp__u8(buf+6); }
